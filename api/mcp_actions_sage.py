...
async def _call_tool_impl_inner(name: str, arguments: dict) -> list[types.TextContent]:
    ...
    if name == "generer_document_sage":
        ...
        ref_article   = arguments.get("ref_article", "")
        qte           = float(arguments.get("qte", 0.0))
        prix_unitaire = float(arguments.get("prix_unitaire", 0.0))
        num_of        = arguments.get("num_of", "")
        lignes        = arguments.get("lignes")

        if type_d == "BL":
            result = _workflow_bl(code_client, ref_article, qte, prix_unitaire, lignes=lignes)
            ...
            result = _generer_facture_directe(code_client, ref_article, qte, prix_unitaire, lignes=lignes)
        ...
        result = _workflow_bl(
            ...
            arguments.get("ref_article", ""),
            float(arguments.get("quantite", 0.0)),
            float(arguments.get("prix_unitaire", 0.0)),
            arguments.get("date_doc"),
            lignes=arguments.get("lignes"),
        )
        return _to_text(result)
