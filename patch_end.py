...
# We need to find the specific state['statut_draft'] = 'PREVIEW' inside noeud_collecte_draft
...
# Find the last 'state['statut_draft'] = 'PREVIEW''
...
if old_str in sub:
    ...
    print("Could not find old_str in sub. Let's see what is there.")
    print(repr(sub[-200:]))
